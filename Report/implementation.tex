...
\lstinputlisting[language={java}, caption={First part of exercise generation.},label={lst:conditionals_gen1.java}]{\listings/conditionals_gen1.java}
...
\lstinputlisting[language={java}, caption={Code generating template},label={lst:conditionals_template.java}]{\listings/conditionals.template}
...
\lstinputlisting[language={java}, caption={Generating question and choices.},label={lst:conditionals_gen2.java}]{\listings/conditionals_gen2.java}
