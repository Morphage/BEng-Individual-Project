...
%
% Add some examples of computing probability of correct answer for certain item parameters to show the effect of each parameter
% In IRT, an item is a question or an exercise. For instance, in a mathematics exam, "What is the square root of 81?" is a possible item. Let that item have 3PL parameters a=1.2 b=5 and c=0.25 in a multiple choice question.
%
