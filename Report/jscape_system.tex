...
The teacher's main access to the system is through the jSCAPE admin tool. Essentially it provides an interface to the database, so that teachers not familiar with SQL can still retrieve useful data about students.
