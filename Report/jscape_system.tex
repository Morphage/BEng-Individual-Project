...
% some HEURISTICS used by the system to increase the difficulty are increasing the size of the binary tree, the size of the code, the number of variables to consider, the type of the exercise, etc...
